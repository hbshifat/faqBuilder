        ...
        <div v-if="showEdit" class="ninja_editor_overflow">
            ...
            <div class="editor_overflow_content">
                ...
                <ninja-switch
                        v-if="show_hide"
                        :title="'Hide '+title"
                        :switch.sync="value.hide_section"
                ></ninja-switch>
                <template v-if="value.hide_section != 'yes'">
...
<script type="text/babel">
    ...
    import NinjaSwitch from './Switch';

    export default {
        name: 'element_styling_group',
        components: {
            NinjaEditorElement,
            NinjaSwitch
        },
        props: ['title', 'value', 'fieldMaps', 'header_title', 'enable_delete', 'do_edit', 'show_hide'],
        data() {
            return {
                showEdit: false
            }
